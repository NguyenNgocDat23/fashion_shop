...
<body>
    ...
    border: none;"><i class="fa-solid fa-right-from-bracket"></i></button>
                        </form>
                    </li>
                    @endif
                        ...
                        <div class="table-responsive">
                            <table class="table shoping-cart-table">
                                ...
                                <tr>
                                    ...
                                    <td class="desc">
                                        <h3>
                                        <a href="{{route('shop.single', $data->product->id)}}" class="text-navy">{{$data->product->name}}</a>
                                        </h3>
