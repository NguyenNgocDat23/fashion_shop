        ...
        <div class="card mb-4">
          <div class="card-body text-center">
            ...
            <div class="d-flex justify-content-center mb-2">
              ...
              <a href="{{route('favorite.index')}}" class="btn btn-outline-primary ms-1">Favorites</a>
            </div>
          </div>
        </div>
            ...
            <form method="POST" action="{{ route('update-password') }}" >
              @csrf
                ...
                <div class="form-group pass_show"> 
                    <input type="password" id="current-password" name="old_password" class="form-control" placeholder="Current Password"> 
                    @if(session('error'))
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group pass_show"> 
                        ...
                        @if(session('error_confirm_password'))<span class="text-danger">{{ session('error_confirm_password') }}</span> @endif
                      </div> 
                  </div>
                  <div class="col-md-6">            
