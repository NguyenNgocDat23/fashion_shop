...
Route::get('favorite/{favorite_id}', [FavoriteController::class, 'store'])->name('favorite.create');
Route::get('delete-favorite/{favorite_id}', [FavoriteController::class, 'destroy'])->name('favorite.destroy');